...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=WiJFgAAR#bi_r_Dq9NPb5phNNjjNLCRqG5HtyngGNLhrIM0LSJYI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '260771798128,260767829703' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "asitha" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Geaan , Cyrus is alive now!!*" : process.env.ALIVE_MSG,
